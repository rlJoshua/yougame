 ...
 */
final class Version20200121101600 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE game DROP plateform_id');
    }
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE game ADD CONSTRAINT FK_232B318CCCAA542F FOREIGN KEY (platform_id) REFERENCES platform (id)');
        $this->addSql('CREATE INDEX IDX_232B318CCCAA542F ON game (platform_id)');
    }
}
